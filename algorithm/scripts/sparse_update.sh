...
python train_cls.py   configs/transfer.yaml --run_dir runs/human/mcunet-5fps/sparse_100kb/sgd_qas_nomom ^
    --net_name mcunet-5fps  --bs256_lr  0.1  --optimizer_name sgd_nomom ^
    --enable_backward_config 0 --n_bias_update 22 --manual_weight_idx 21-24-27-30-36-39 ^
